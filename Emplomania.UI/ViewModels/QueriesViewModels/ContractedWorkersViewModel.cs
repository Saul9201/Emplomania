...
{
    public class ContractedWorkersViewModel : EMViewModelBase
    {
        public ContractedWorkersViewModel(EMMainViewModel centralEMMain) : base(centralEMMain)
        {
            Subtitle = "Trabajadores Contratados";
